...
{    
    ...
    int32_t Config::num_vocabs = 1000000;
    int32_t Config::num_topics = 1000;
    int32_t Config::num_iterations = 10;
    ...
    int64_t Config::data_capacity = 8 * kMB;
